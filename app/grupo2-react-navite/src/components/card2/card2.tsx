...
export const Card = ({ pokemon,selectStats, setSelectStats } : CardProps ) => {
      ...
      (
        <View style={styles.container_attributes}>
          ...
          {pokemon.stats.map((stat, index) => (
            ...
            <Text style={styles.attributes_text} key={stat.stat.name}>{stat.stat.name}: {stat.base_stat}</Text>
            </TouchableOpacity>
          ))} 
